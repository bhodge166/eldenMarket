  ...
  return (
    <div className="bkg" style={{ height: "100%" }}>
      <div className="counter">
        <h1
          className="starA"
          style={{ fontSize: "84px", textDecorationLine: "underline" }}
        >
          Boss Fight!{" "}
        </h1>
        <h3 className="starB" style={{ fontSize: "48px" }}>
          <span
            style={{ fontWeight: "bold", fontStyle: "italic", color: "white" }}
          >
            "I Am Malenia, Blade Of Miquella, And I Have Never Known Defeat."
          </span>{" "}
          <br></br>-Malenia, Blade Of Miquella.
        </h3>
        ...
        <img
          ...
          id="face"
          className=" w-25"
          onClick={(myTimer) => handleAddRunes()}
        />
        ...
        <button className="control__btn" onClick={() => handleAddRunes()}>
          <img src={weapon} className="icon" style={{ width: "85px" }} />
          Swing your{" "}
          <span className="starA" style={{ fontSize: "24px" }}>
            weapon
          </span>{" "}
          to earn 1000 runes
        </button>
        <button className="control__btn" onClick={() => handleAddRunes()}>
          <img src={spells} className="icon" />
          Cast a{" "}
          <span className="starA" style={{ fontSize: "24px" }}>
            Spell
          </span>{" "}
        ...
        <button className="control__btn" onClick={() => handleAddRunes()}>
          <img src={spells} className="icon" /> Send a{" "}
          <span className="starA" style={{ fontSize: "24px" }}>
            pet
          </span>{" "}
          to earn 1000 runes
